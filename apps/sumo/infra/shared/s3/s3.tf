...
resource "aws_s3_bucket" "logs" {
  bucket = "sumo-media-logs"
  acl    = "log-delivery-write"
}

resource "aws_s3_bucket" "sumo-stage-media" {
  bucket = "sumo-stage-media"
  region = "${var.region}"
  acl    = "log-delivery-write"
  ...
  website_domain   = "s3-website-${var.region}.amazonaws.com"
  website_endpoint = "sumo-stage-media.s3-website-${var.region}.amazonaws.com"
...
{
  "Version": "2012-10-17",
  "Id": "sumo-stage-media policy",
  "Statement": [
    {
      "Sid": "SumoStageMediaAllowListBucket",
      "Effect": "Allow",
      "Principal": "*",
      "Action": "s3:ListBucket",
      "Resource": "arn:aws:s3:::sumo-stage-media"
    },
    {
      "Sid": "SumoStageMediaAllowIndexDotHTML",
      "Effect": "Allow",
      "Principal": "*",
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::sumo-stage-media/*"
...
resource "aws_s3_bucket" "sumo-prod-media" {
  ...
  website_domain   = "s3-website-${var.region}.amazonaws.com"
  website_endpoint = "sumo-prod-media.s3-website-${var.region}.amazonaws.com"
...
{
  "Version": "2012-10-17",
  "Id": "sumo-prod-media policy",
  "Statement": [
    {
      "Sid": "SumoProdMediaAllowListBucket",
      "Effect": "Allow",
      "Principal": "*",
      "Action": "s3:ListBucket",
      "Resource": "arn:aws:s3:::sumo-prod-media"
    },
    {
      "Sid": "SumoProdMediaAllowIndexDotHTML",
      "Effect": "Allow",
      "Principal": "*",
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::sumo-prod-media/*"
