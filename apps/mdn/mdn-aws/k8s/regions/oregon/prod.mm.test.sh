...
export KUMA_ATTACHMENT_HOST=demos.mdn.mozit.cloud
...
export KUMA_DOMAIN=developer-prod.mdn.mozit.cloud
...
export KUMA_MEDIA_URL=https://developer-prod.mdn.mozit.cloud/media/
