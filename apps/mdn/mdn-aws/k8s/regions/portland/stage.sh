...
export SHARED_PV_ARN=${MDN_STAGE_EFS_ARN}
...
export WEB_SERVICE_CERT_ARN=${MDN_STAGE_CERT_ARN}
...
export KUMASCRIPT_MEMCACHED_URL=${MDN_STAGE_MEMCACHED_URL}
...
export KUMA_CELERY_BROKER_URL=${MDN_STAGE_REDIS_URL}
export KUMA_DATABASE_URL=${MDN_STAGE_DATABASE_URL}
export KUMA_MEMCACHED_URL=${MDN_STAGE_MEMCACHED_URL}
export KUMA_ELASTICSEARCH_URL=${MDN_STAGE_ELASTICSEARCH_URL}
