...
export WEB_ALLOWED_HOSTS="developer.allizom.org,developer-samples.allizom.org"
...
export KUMA_ADMIN_EMAILS=mdn-dev@mozilla.com
...
export KUMA_DEFAULT_FROM_EMAIL=notifications@developer-dev.allizom.org
...
export KUMA_SERVER_EMAIL=server-error@developer-dev.allizom.org
